  ...
  return (
    <div className="bg-gray-950 text-white min-h-screen">
      ...
      <section className="bg-gradient-to-r from-gray-900 via-gray-800 to-black py-16 text-center">
        ...
        <p className="mt-4 text-gray-300 text-lg">Pick your plan. Smash your goals. Start today! 💪</p>
      </section>
      ...
      <section className="py-20 px-6 bg-gray-900">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-yellow-400 mb-12">What's Included in Every Plan</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition">
              ...
              <p className="text-gray-300 text-sm">Train with world-class machines designed for results.</p>
            </div>
            ...
            <div className="bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition">
              ...
              <p className="text-gray-300 text-sm">Workout anytime with our extended opening hours.</p>
            </div>
            ...
            <div className="bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-yellow-400 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a2 2 0 00-2-2h-3V9a4 4 0 00-8 0v7H6a2 2 0 00-2 2v2h5" />
              </svg>
              <h3 className="text-xl font-semibold mb-2">Supportive Community</h3>
              <p className="text-gray-300 text-sm">Be part of a motivating & inspiring fitness family.</p>
            </div>
      ...
      <section className="py-20 px-6 bg-gray-900">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-extrabold text-yellow-400 text-center mb-12">Frequently Asked Questions</h2>
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div key={index} className="bg-gray-800 rounded-2xl shadow-md">
                ...
                {openFaq === index && (
                  <div className="px-5 pb-5 text-gray-300 text-base">
                    {faq.answer}
                  </div>
                )}
              </div>
