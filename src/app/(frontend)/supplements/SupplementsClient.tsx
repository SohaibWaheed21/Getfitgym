...
export default function SupplementsClient({ supplements }: { supplements: Supplement[] }) {
  ...
  const categories = [
    'all',
    ...Array.from(
      new Set(supplements.map((s) => s.category).filter((c): c is string => Boolean(c))),
    ),
  ]
      ...
      <div className="min-h-screen bg-gray-50 font-sans text-gray-800">
        ...
        <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-black py-20 gradient-animated overflow-hidden">
          ...
          <div className="header-particles absolute w-full h-full overflow-hidden z-1">
            <div
              className="particle absolute bg-yellow-500/15 rounded-full w-20 h-20 left-[10%]"
              style={{ animation: 'float 12s infinite ease-in-out' }}
            ></div>
            <div
              className="particle absolute bg-yellow-500/15 rounded-full w-15 h-15 left-[25%]"
              style={{ animation: 'float 15s infinite ease-in-out', animationDelay: '2s' }}
            ></div>
            <div
              className="particle absolute bg-yellow-500/15 rounded-full w-25 h-25 left-[50%]"
              style={{ animation: 'float 18s infinite ease-in-out', animationDelay: '4s' }}
            ></div>
            <div
              className="particle absolute bg-yellow-500/15 rounded-full w-[70px] h-[70px] left-[70%]"
              style={{ animation: 'float 14s infinite ease-in-out', animationDelay: '1s' }}
            ></div>
            <div
              className="particle absolute bg-yellow-500/15 rounded-full w-[90px] h-[90px] left-[85%]"
              style={{ animation: 'float 16s infinite ease-in-out', animationDelay: '3s' }}
            ></div>
            <div
              className="particle absolute bg-yellow-500/15 rounded-full w-[65px] h-[65px] left-[40%]"
              style={{ animation: 'float 13s infinite ease-in-out', animationDelay: '5s' }}
            ></div>
          </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto text-center px-6">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto animate-fadeUp delay-200">
              Fuel your fitness journey with our carefully selected, high-quality supplements
        ...
        <section className="max-w-6xl mx-auto py-16 px-6">
          <div className="grid md:grid-cols-2 gap-12">
            {filteredSupplements.map((supplement) => (
              <div
                key={supplement.id}
                className="product-card bg-white rounded-3xl shadow-professional-xl overflow-hidden scroll-reveal"
              >
                {/* Product Image */}
                <div className="relative w-full h-80 bg-gradient-to-br from-gray-50 to-gray-100 overflow-hidden image-zoom rounded-t-2xl flex items-center justify-center p-4">
                  ...
                  {supplement.badge && (
                    <div
                      className={`absolute top-4 right-4 ${supplement.badgeColor || 'bg-red-500'} text-white px-3 py-1 rounded-full text-sm font-semibold shadow-professional badge-pulse`}
                    >
                      {supplement.badge}
                    </div>
                  )}
                ...
                <div className="p-8">
                  ...
                  {/* Specs */}
                  {supplement.specs && (
                    <div className="mt-4 text-sm text-gray-600">{supplement.specs}</div>
                  )}
                </div>
              </div>
            ))}
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="fade-in-up bg-gray-800 p-8 rounded-2xl transform hover:scale-105 transition duration-300 feature-card">
                ...
                <p className="text-gray-300">
                  All products are third-party tested for purity and potency. We source only the
              ...
              <div className="fade-in-up bg-gray-800 p-8 rounded-2xl transform hover:scale-105 transition duration-300 feature-card">
                ...
                <p className="text-gray-300">
                  Recommended by certified nutritionists and fitness professionals. Proven
              ...
              <div className="fade-in-up bg-gray-800 p-8 rounded-2xl transform hover:scale-105 transition duration-300 feature-card">
                ...
                <p className="text-gray-300">
                  Free delivery within Lahore. Fast and secure shipping to ensure your supplements
                  arrive fresh.
                </p>
              </div>
            </div>
        ...
        <section className="bg-yellow-500 py-12">
          <div className="max-w-4xl mx-auto text-center px-6">
            ...
            <p className="text-lg text-gray-800 mb-8">
              Join thousands of satisfied customers who trust GetFit supplements for their fitness
              goals.
            </p>
        ...
        <footer className="bg-gray-950 text-gray-400 py-10 border-t-2 border-yellow-500/20 glow-yellow">
          <div className="max-w-6xl mx-auto px-6 grid gap-10 md:grid-cols-3 text-center md:text-left">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link href="/" className="link-glow hover:text-yellow-400 transition">
                    Home
                  </Link>
                </li>
                <li>
                  <Link href="/trainers" className="link-glow hover:text-yellow-400 transition">
                    Trainers
                  </Link>
                </li>
                <li>
                  <Link href="/supplements" className="link-glow hover:text-yellow-400 transition">
                    Supplements
                  </Link>
                </li>
                <li>
                  <Link href="/pricing" className="link-glow hover:text-yellow-400 transition">
                    Pricing
                  </Link>
                </li>
              </ul>
          ...
          <div className="text-center text-gray-500 mt-8 border-t border-gray-800 pt-4 text-sm">
            &copy; 2025 <span className="text-yellow-500 font-semibold">GetFit Gym</span>. All
            rights reserved.
          </div>
        </footer>
