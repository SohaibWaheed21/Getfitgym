...
export default function CartSidebar({
  ...
  return (
    <div
      className={`fixed top-0 right-0 h-full w-full md:w-96 bg-white shadow-2xl transform ${open ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 z-50 flex flex-col`}
    >
      ...
      <div className="p-6 bg-gray-50 border-t">
        ...
        <button
          onClick={onCheckout}
          className="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white py-3 rounded-xl font-semibold shadow-lg transition mb-3"
        >
          Place Order
        </button>
        <button
          onClick={handleWhatsAppOrder}
          className="w-full flex justify-center items-center bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white py-3 rounded-xl font-semibold shadow-lg transition text-center"
        >
